...
| `helix-invocation-guide.md` | `output/` | How students invoke Helix from the terminal: command syntax, flag options, when to use Helix vs reading the site. Included in Zone 04 Lesson 01 — Helix's first appearance. Not in Zones 01-03 (standard Claude). |
