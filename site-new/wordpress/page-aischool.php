 ...
 *    - "course"   → Assign template: AI School Page
 *    - "catalog"  → Assign template: AI School Page
 *    - "library"  → Assign template: AI School Page
 *    - "projects" → Assign template: AI School Page
 *    - "glossary" → Assign template: AI School Page
 *
